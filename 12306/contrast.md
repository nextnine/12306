...
v13-requirements 579-583行：
| 日常流量 | 10万/秒 | 2万/秒 | 500万单 | 50万 |

v13-system_design 28-32行：  
| 日常流量 | 10万/秒 | 2万/秒 | 500万单 | 50万 |

v2.0 26-28行：
查询：P95 < 120ms，峰值命中率≥95%，系统可用性 99.99%
写峰值/出队后下单：P95 < 3s... 排队削峰后写峰值 ≥20 万 TPS

问题：
❌ 三个版本的QPS定义略有歧义
   - "10万QPS"是查询还是包含所有请求？
   - v2.0强调"出队后"的TPS vs v13直接QPS，概念不同
   - 应该明确：查询QPS vs 下单TPS vs 总TPS
